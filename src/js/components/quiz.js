const quizData = [{
  number: 1,
  title: "Какое мыло вам нужно?",
  answer_alias: "type",
  answers: [{
    answer_title: "Детское",
    type: "checkbox"
  },
    {
      answer_title: "Туалетное",
      type: "checkbox"
    },
    {
      answer_title: "Специальное",
      type: "checkbox"
    },
  ]
},
  {
    number: 2,
    title: "Какой вес мыло вам нужен?",
    answer_alias: "size",
    answers: [{
      answer_title: "40 грамм",
      type: "checkbox"
    },
      {
        answer_title: "80 грамм",
        type: "checkbox"
      },
      {
        answer_title: "120 грамм",
        type: "checkbox"
      },
      {
        answer_title: "160 грамм",
        type: "checkbox"
      },
      {
        answer_title: "160 грамм и более",
        type: "checkbox"
      }
    ]
  },
  {
    number: 3,
    title: "Уточните какие-нибудь моменты",
  ...
  const answers = data.answers.map(item => {
    if (item.type  === 'checkbox') {
      return `
          ...
          <img src="img/quiz-image.jpg" alt="">
          <label class="custom-checkbox quiz-question__label custom-checkbox__quiz">
